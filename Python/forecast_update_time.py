...
def main():
  ...
  whitworth_url = "http://manunicast.seaes.manchester.ac.uk/charts/manunicast/20180314/d02/meteograms/meteo_WHIT_2018-03-13_1800_data.txt"
  ...
  while True:
    ...
    if not code == 200:
      ...
      print("Outputting data to 'forecast_update.data'...")
      out = open("forecast_update.data", "w")
      out.write(statement)
      out.write(str(data))
      out.close()
      break
