...
def main():
  ...
  whitworth_url = "http://manunicast.seaes.manchester.ac.uk/charts/manunicast/20180315/d02/meteograms/meteo_WHIT_2018-03-14_1800_data.txt"
  ...
  while True:
    ...
    if not code == 200:
      ...
      print("Outputting data to 'forecast_update_whit.data'...")
      out = open("forecast_update_whit.data", "w")
      out.write(statement)
      out.write(str(data))
      out.close()
      break
